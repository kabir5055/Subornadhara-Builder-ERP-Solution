...
class FinanceTransactionSeederNew extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        foreach ($incomeTransactions as $transaction) {
            FinanceTransaction::create([
                'transaction_id' => 'INC-' . str_pad(rand(1, 9999), 4, '0', STR_PAD_LEFT),
        ...
        foreach ($expenseTransactions as $transaction) {
            FinanceTransaction::create([
                'transaction_id' => 'EXP-' . str_pad(rand(1, 9999), 4, '0', STR_PAD_LEFT),
                'transaction_date' => Carbon::now()->subDays(rand(1, 180)),
                'description' => $transaction['description'],
                'amount' => $transaction['amount'],
                'type' => $transaction['type'],
        ...
        for ($i = 1; $i <= 30; $i++) {
            ...
            FinanceTransaction::create([
                'transaction_id' => ($isIncome ? 'INC-' : 'EXP-') . str_pad(rand(1, 9999), 4, '0', STR_PAD_LEFT),
