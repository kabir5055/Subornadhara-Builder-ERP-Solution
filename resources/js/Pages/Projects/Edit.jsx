...
export default function Edit({ project }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(window.route('projects.update', { project: project.id }), {
            forceFormData: true,
        });
    };
            ...
            <div className="space-y-6">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-sm text-gray-600">
                                    Update project information for {project.name}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-white shadow-sm rounded-lg border border-gray-200">
                    <div className="px-6 py-4 border-b border-gray-200">
                        ...
                        <p className="text-sm text-gray-500">Update the project details below</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        ...
                        {/* Existing Images Preview (if provided in project) */}
                                ...
                                <div className="flex flex-wrap gap-3">
                                    {project.images.map((img) => (
                                        <div key={img.id} className="w-28">
                                            <img
                                                src={img.url || img.path || img.thumbnail_url}
                                                alt="Project"
